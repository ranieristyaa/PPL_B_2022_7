                ...
                <div class="row" style="margin-top: 10px;">
                  <div class="col-md-6" style="margin-left: 150px; width:400px;">
                    <div class="card text-center" style="height: 100px; background:lightgray; padding: 10px;">
                      <div class="card-body">
                        <h5 class="card-title text-bold">Total Mahasiswa Perwalian Aktif</h5>
                        <?php 
                        ...
                        $queryuser = mysqli_query ($konek, "SELECT COUNT(*) AS aktif FROM mahasiswa WHERE NIP_dosen='$NIP' AND status = 'aktif'");
	                      $user = mysqli_fetch_array ($queryuser);
                        ?>
                  ...
                  <div class="col-md-6" style="margin-left: 150px; width:400px;"">
                    <div class="card text-center" style="height: 100px; background:lightgray; padding: 10px;">
                      <div class="card-body">
                        <h5 class="card-title text-bold">Total Mahasiswa Perwalian Cuti</h5>
                        <?php 
                        require_once('../koneksi.php');
                        $queryuser = mysqli_query ($konek, "SELECT NIP FROM dosen WHERE Id_User=".$_SESSION["Id_User"]);
	                      $user = mysqli_fetch_array ($queryuser);
                        $NIP = $user["NIP"];
                        $queryuser = mysqli_query ($konek, "SELECT COUNT(*) AS cuti FROM mahasiswa WHERE NIP_dosen='$NIP' AND status = 'cuti'");
	                      $user = mysqli_fetch_array ($queryuser);
                        ?>
                        ...
                        const data = {
                          ...
                          datasets: [{
                            ...
                            data: [
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a15 = mysqli_query($konek,"select * from mahasiswa where angkatan=2015 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a15);
                                  ?>, 
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a16 = mysqli_query($konek,"select * from mahasiswa where angkatan=2016 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a16);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a17 = mysqli_query($konek,"select * from mahasiswa where angkatan=2017 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a17);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a18 = mysqli_query($konek,"select * from mahasiswa where angkatan=2018 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a18);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a19 = mysqli_query($konek,"select * from mahasiswa where angkatan=2019 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a19);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a20 = mysqli_query($konek,"select * from mahasiswa where angkatan=2020 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a20);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a21 = mysqli_query($konek,"select * from mahasiswa where angkatan=2021 and NIP_dosen='$NIP'");
                                  echo mysqli_num_rows($a21);
                                  ?>,
                                  <?php 
                                  require_once('../koneksi.php');
                                  $a22 = mysqli_query($konek,"select * from mahasiswa where angkatan=2022 and NIP_dosen='$NIP'");
