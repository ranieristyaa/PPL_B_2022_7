  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <center>
					<button class="btn btn-outline-success" id="allp" type="button" >All</button>
					<button class="btn btn-outline-success" id="a16p" type="button">2016</button>
					<button class="btn btn-outline-success" id="a17p" type="button">2017</button>
					<button class="btn btn-outline-success" id="a18p" type="button">2018</button>
					<button class="btn btn-outline-success" id="a19p" type="button">2019</button>
					<button class="btn btn-outline-success" id="a20p" type="button">2020</button>
					<button class="btn btn-outline-success" id="a21p" type="button" >2021</button>
					<button class="btn btn-outline-success" id="a22p" type="button" >2022</button>
					</center>
				</form>
				</nav>
