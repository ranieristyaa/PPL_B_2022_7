	...
	<script type="text/javascript">
		...
		$("#a20").click(function(e) {
			...
			$("#allp").click(function(e) {
				$.ajax({
					url: "mhs_all_progress.php",
					type: "GET",
					data : {},
					success: function (ajaxData){
					$("#data").html(ajaxData);
