...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2022 at 06:36 AM
...
('098980', 'Derry', '2017-03-15', 'L', '2324', 'aasdad', 21),
('DS003', 'Iksan Derry S', '2017-03-14', 'L', '0897761', 'Cimahi', 2);
...
('44', 0, 22, 96, 3.5, 3.6, 0x5072616b312d496e74726f64756374696f6e20746f204d616368696e65204c6561726e696e6720616e6420476f6f676c6520436f6c61622e706466);
...
CREATE TABLE `mahasiswa` (
  ...
  `jalur_masuk` enum('UM','IUP','SBMPTN','SNMPTN','SBUB') NOT NULL,
...
INSERT INTO `mahasiswa` (`NIM`, `Nama_Mahasiswa`, `Tanggal_Lahir`, `JK`, `No_Telp`, `email`, `Alamat`, `angkatan`, `jalur_masuk`, `status`, `semester_aktif`, `foto`, `NIP_dosen`, `Id_User`) VALUES
('12', 'ca', '2022-10-06', 'P', '000', '', 'p', 2020, 'UM', 'aktif', 0, '', 'DS003', 0),
('44', 'ccc', '2002-10-03', 'P', '11111', '', 'd', 2021, 'SBMPTN', 'aktif', 5, '', '098980', 22),
('D980098', 'Ikhsan', '2017-03-15', 'L', '0989809', '', 'Bandung', 2020, 'UM', 'aktif', 7, '', '098980', 0),
('D980980', 'Deerry', '2017-03-15', 'L', '234234', '', 'Cimahi', 2020, 'UM', 'aktif', 0, '', '098980', 0);
...
('12', 'on progress', NULL, NULL),
('44', 'belum', '', ''),
('D980098', 'sudah', 'A', 0x50315f375f50504c42202831292e706466),
('D980980', 'on progress', '', 0x50325f375f50504c422e706466);
...
('44', 'belum', '0000-00-00', '', 0, ''),
('D980098', 'sudah', '2022-10-02', 'A', 8, 0x50325f375f50504c42202831292e706466);
...
(20, 4, 'departemen', '$2y$10$4./hOeeyfQ32lp19etZ1q.ZoOkzHAzQpmNQ3Y0/g4rmyJon3kTx8e', 'Septiana Eka Putri', 'ids.jpg'),
(21, 2, 'dosen', '$2y$10$e2Uz3rc6e9Aftp/cjJ7ecuqLnmHVCbWRQ.d4Fp38lxPMHLvELmtf.', 'Asy-Syifa Al-A\'la', 'ids.jpg'),
(22, 3, 'mahasiswa', '$2y$10$Nu4pOZoN1Sq6DE3aEU4afuFhPEY7OmBMknoqqZXuOnkQHZCMT82Nm', 'Nurul Uswatun Hasanah', 'ids.jpg'),
(23, 3, '44', '$2y$10$baO6HlTxLUnbKxojBC.O1uTD6q4z8Gap6B2MiaVJog0JFC5wPwb..', '', 'ids.jpg'),
(24, 4, 'DS003', '$2y$10$SV8xya9FIzPZvOWzjzU/KuFfTuW4iVQrFnpJFNeLJ/Lb7f4lORb6u', '', 'ids.jpg'),
(25, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg'),
(26, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg'),
(27, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg'),
(28, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg'),
(29, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg'),
(30, 3, '24060120130067', '24060120130067', 'Chaerani Eristyawati', 'ids.jpg');
...
--
ALTER TABLE `irs`
  ADD CONSTRAINT `FK_irs_mhs` FOREIGN KEY (`NIM`) REFERENCES `mahasiswa` (`NIM`);

--
-- Constraints for table `khs`
--
ALTER TABLE `khs`
  ADD CONSTRAINT `FK_khs_mhs` FOREIGN KEY (`NIM`) REFERENCES `mahasiswa` (`NIM`);
...
--
ALTER TABLE `pkl`
  ADD CONSTRAINT `FK_PKL_mahasiswa` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`NIM`);
