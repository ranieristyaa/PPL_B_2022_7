  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="header">
            ...
            <li class="active"><a href="input_pkl.php"><i class="fa fa-university"></i><span>Data PKL</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-university"></i>  Data PKL</li>
          </ol>
        </section>
            ...
            <div class="col-xs-12">
              <div class="box" style="height: 655px;">
                ...
                <div class="box-body" style="padding-left: 550px; padding-right: 550px;">
                          ...
                          <!-- // Form -->
                          <form action="pkl_add.php" enctype="multipart/form-data" method="post">
