...
$queryuser = mysqli_query ($konek, "SELECT NIM FROM mahasiswa WHERE Id_User=".$_SESSION["Id_User"]);
  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="header">
            ...
            <li class="active"><a href="input_irs.php"><i class="fa fa-file-o"></i><span>Data IRS</span></a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><i class="fa fa-file-o"></i>  Data IRS</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box" style="height: 655px;">
                ...
                <div class="box-body" style="padding-left: 550px; padding-right: 550px;">
                
                          <!-- // Form -->
                          <form action="irs_add.php" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                              <label>jumlah SKS</label>
                                <div class="input-group">
                                  ...
                                  <input name="SKS" type="number" accept=".pdf" class="form-control" placeholder="Jumlah SKS" required/>
                                </div>
                            </div>
                            <div class="form-group">
                              <label>Scan IRS</label>
                                <div class="input-group">
                                  ...
                                  <input name="scan" type="file" class="form-control" placeholder="Scan IRS" required/>
                                </div>
                            </div>
  ...
  <?php 
                        ...
                        <script>
                            swal({
                              title: "Success",
                              type: "success",
                              html: "<b>Data IRS berhasil ditambahkan</b>",
                              width: '40%',
                              hight: '70%'
                          });
                        </script>
