    ...
    <div class="form-group">
      <label>Jalur Masuk</label>
        <div class="input-group">
          ...
          <select name="jalur" id="jalur" class="form-control" required readonly>
    ...
    <div class="form-group" <?php if(!isset($mhs['id_prov'])) echo 'style="display: none;"';?>>
      <label>Provinsi</label>
        <div class="input-group">
          ...
          <?php $qprov = mysqli_query($konek, "SELECT * FROM provinsi where id_prov=".$mhs['id_prov']);
    ...
    <div class="form-group" <?php if(!isset($mhs['id_kab'])) echo 'style="display: none;"';?>>
      <label>Kabupaten/Kota</label>
        <div class="input-group">
          ...
          <?php $qprov = mysqli_query($konek, "SELECT * FROM kabupaten where id_kab=".$mhs['id_kab']);
