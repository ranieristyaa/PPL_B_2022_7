...
INSERT INTO `dosen` (`NIP`, `Nama_Dosen`, `Tanggal_Lahir`, `JK`, `No_Telp`, `Alamat`, `Id_User`) VALUES
('196511071992031000', 'tes', '0000-00-00', 'L', '', '', 49),
('196511071992031003', 'Drs. Eko Adi Sarwoko, M.Kom', '0000-00-00', 'L', '2324', 'aasdad', 34),
('197404011999031002', 'Dr. Aris Puji Widodo, S.Si, M.T', '0000-00-00', 'L', '0897761', 'Cimahi', 2);
...
CREATE TABLE `irs` (
  `NIM` varchar(14) CHARACTER SET latin1 NOT NULL,
  `semester` int(1) NOT NULL,
  `sks` int(2) NOT NULL,
  `status_konfirmasi` enum('belum','sudah') NOT NULL,
...
INSERT INTO `irs` (`NIM`, `semester`, `sks`, `status_konfirmasi`, `scan`) VALUES
('24060120140000', 1, 22, 'sudah', 0x30322e2055736572204d616e75616c2e706466),
('24060120140001', 1, 21, 'belum', 0x3330372d41727469636c6520546578742d3738362d332d31302d32303230303531362e706466),
('44', 5, 21, 'sudah', 0x375f50504c422e706466),
('D980098', 7, 20, 'belum', '');
...
INSERT INTO `khs` (`NIM`, `semester`, `sks`, `sksk`, `ips`, `ipk`, `scan`) VALUES
('24060120140000', 1, 21, 21, 2, 2, 0x30322e2055736572204d616e75616c2e706466);
...
CREATE TABLE `mahasiswa` (
  ...
  `jalur_masuk` enum('UM','IUP','SBMPTN','SNMPTN','SBUB') DEFAULT NULL,
...
INSERT INTO `mahasiswa` (`NIM`, `Nama_Mahasiswa`, `Tanggal_Lahir`, `JK`, `No_Telp`, `email`, `Alamat`, `angkatan`, `jalur_masuk`, `status`, `semester_aktif`, `foto`, `NIP_dosen`, `Id_User`, `id_prov`, `id_kab`) VALUES
('24060120130067', 'Rani', '0000-00-00', 'P', '', '', '', 2020, 'UM', 'aktif', 0, '', '196511071992031000', 54, NULL, NULL),
('24060120140000', 'tes', '1991-11-03', 'P', '', '', '', 2020, NULL, 'aktif', 0, '', '196511071992031000', 56, NULL, NULL),
('24060120140001', 'Putri Indah', '0000-00-00', '', '081234770143', 'put@gmail.com', 'jl. gondang timur no 2', 2020, 'UM', 'aktif', 5, '8c23a4b1d2f458d3684999c173f6aded.jpg', '196511071992031003', 31, '33', '3374'),
('24060120140002', 'Muhammad Bono', '0000-00-00', '', '', '', '', 2020, 'UM', 'aktif', 0, '', '196511071992031003', 0, NULL, NULL),
('24060120140004', 'tes', '0000-00-00', 'L', '111', 'a@gmail.com', 'bbbb', 2019, 'UM', 'aktif', 0, '10a136acca1a9b9be5b447a802c64f1f.jpg', '196511071992031003', 45, '13', '1301'),
('24060120140006', 'Jojo', '0000-00-00', 'P', '', '', '', 2021, 'UM', 'aktif', 0, '', '196511071992031003', 0, NULL, NULL),
('24060120140007', 'Jojo', '0000-00-00', 'P', '', '', '', 2021, 'UM', 'aktif', 0, '', '196511071992031003', 0, NULL, NULL),
('24060120140010', 'pp', '2022-12-05', 'P', '', 'a@gmail.com', '', 2020, 'SBMPTN', 'aktif', 0, '', '196511071992031003', 46, '14', '1401');
...
CREATE TABLE `pkl` (
  ...
  `status` enum('belum','on progress','sudah') NOT NULL,
  `nilai` varchar(1) DEFAULT NULL,
  `scan` longblob DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `pkl` (`nim`, `status`, `nilai`, `scan`) VALUES
('24060120140000', 'belum', '', ''),
('24060120140001', 'belum', '', '');
...
INSERT INTO `skripsi` (`NIM`, `status`, `tgl_sidang`, `nilai`, `lama_studi`, `scan`) VALUES
('24060120140000', 'belum', '0000-00-00', '', 0, ''),
('24060120140001', 'belum', '0000-00-00', '', 0, '');
...
INSERT INTO `user` (`Id_User`, `Id_Usergroup_User`, `Username`, `Password`, `nama_lengkap`, `Foto`) VALUES
(1, 1, 'admin', '$2y$10$V7zDd2Fz3QBmWFz3UnZBM.vjDK.AOTTjIdssUY8rhcBjEEJrxY7ma', 'Chaerani Eristyawati', 'undip.png'),
(31, 3, '24060120140001', '$2y$10$PegALVUdbJNtAnLg3Sd5aOqvf.RO6eS3k8Flo.miQcY.obDOIxIQi', 'Putri Indah', 'ids.jpg'),
(34, 2, '196511071992031003', '$2y$10$QMW2YqAOyFErw9ArcR8Y1O49/NJIX1U/OVl2/s9u/kInxTaNofbDO', 'Drs. Eko Adi Sarwoko, M.Kom', 'ids.jpg'),
(35, 4, '197404011999031002', '$2y$10$bu034FpPdFiUutXS04dNv.LeZus79fyQ/4sFEODd3TwAdLwYEnnGe', 'Dr. Aris Puji Widodo, S.Si, M.T', 'ids.jpg'),
(39, 3, '24060120140002', '$2y$10$Qe2qQcNOIH4rJvZLF/K.N.yvAw6L3EtVJ5WiUAEFNZChmhG4S8Fx6', '', 'ids.jpg'),
(43, 3, '24060120140006', '$2y$10$7wUuZvru8nIeF5VeYkg.FutklPjJXYuR.0YOJsvPA0AgtHM3f1NVC', 'Jojo', 'ids.jpg'),
(44, 3, '24060120140007', '$2y$10$vv23auruLmTtPskdV1GXvuX.JRsSuHd3cYpGTGWDMpAn.JaKNUD.S', 'Jojo', 'ids.jpg'),
(45, 3, '24060120140004', '$2y$10$eNqenuG5HIWWzbxofYcmJuTvpVPoSfpNggiclIuFEcycWmfzaxEo6', 'tes', 'ids.jpg'),
(46, 3, '24060120140010', '$2y$10$4fdwR0tz1yVPzZXqQ1IxJuHd2ya64fCiJy8mU9cBhD/bs/zCEc7ta', '', 'ids.jpg'),
(49, 2, '196511071992031000', '$2y$10$..kwI9wF7aXr1CoiHQ4SCulmLGyGgUyLQWduqne7yxfP1st.2vtrq', 'tes', 'ids.jpg'),
(54, 3, '24060120130067', '$2y$10$fF40y3G2d4uuD1bBwoEyX.VbmfdKlTkm482ZIGIxThiKjOKEZ7N/O', '', 'ids.jpg');
...
ALTER TABLE `mahasiswa`
  ADD PRIMARY KEY (`NIM`),
  ADD KEY `FK_Mhs_Dosen` (`NIP_dosen`);
...
--
ALTER TABLE `usergroup`
  MODIFY `Id_Usergroup` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `mahasiswa`
  ADD CONSTRAINT `FK_Mhs_Dosen` FOREIGN KEY (`NIP_dosen`) REFERENCES `dosen` (`NIP`);
COMMIT;
