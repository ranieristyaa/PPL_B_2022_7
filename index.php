      ...
      <div class="login-box-body">
        ...
        <form action="vl_user.php" method="post">
          <div class="form-group has-feedback">
            <input type="text" name="Username" class="form-control" placeholder="NIM/NIP/Username/Email" maxlength="30" />
          ...
          <div class="row">
            ...
            <div class="col-xs-12">
              <button type="submit" class="btn btn-primary btn-sm btn-block">LOGIN <i></i></button>
              <a href="register.php"><i class=""></i><u>Belum memiliki akun</u></a>
            </div><!-- /.col -->
          </div>
		  <br>
