...
<div id="ModalIRS" class="modal fade" tabindex="-1" role="dialog">
    <?php
    $querymhs = mysqli_query($konek, "SELECT * FROM irs WHERE NIM='$NIM' and semester='4'");
    if($querymhs == false){
        ...
        <div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header ">
						...
						<h4 class="modal-title ">Detail IRS Mahasiswa Semester 4</h4>
					</div>
...
<div id="ModalKHS" class="modal fade" tabindex="-1" role="dialog">
    <?php
    $querymhs = mysqli_query($konek, "SELECT * FROM khs WHERE NIM='$NIM' and semester='4'");
    if($querymhs == false){
        die ("Terjadi Kesalahan : ". mysqli_error($konek));
    }
    ...
    ?>
        <div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header ">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title ">Detail KHS Mahasiswa Semester 4</h4>
					</div>
					<div class="modal-body">
                        <?php
                        if(!isset($mhs)) {
